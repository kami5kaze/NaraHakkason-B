    ...
    message_template = TemplateSendMessage(      # テンプレートメッセージ
        ...
        template=ButtonsTemplate(                # ボタンテンプレート
            ...
            actions=[                            # メッセージで表示する各ボタンの定義
                ...
                MessageAction(label='なし', text='ここにはない'),
            ]
        )
    )
...
richMenuImagePath='../../../../images/richmenu_1710777121900.jpg'
